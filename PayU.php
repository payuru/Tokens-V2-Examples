...
class PayU
{
	var $luUrl = "https://secure.payu.ru/order/lu.php", 
		...
		$p2pUrl = "https://secure.payu.ru/order/prepaid/NewCardPayout";
...
#====================== LU GENERATE FORM =================================================
    ...
    public function GetLU()
    {
        ...
        $arr['DEBUG'] = $this->debug;
        $arr['ORDER_HASH'] = $this->Signature( $this->checkArray( $arr ) );
        $this->answer = $this->getLUForm( $arr );
        return $this;
    }
...
#-----------------------------
	...
	{	
		...
		return $form . $this->button."</form>".'<script>document.getElementById("payUform").submit();</script>';
	}

    /* LU Form without AutoSubmit */
    public function getLUForm( $data )
    {
